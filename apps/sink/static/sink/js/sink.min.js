...
var files=file_array.sort(function(a,b){return(a.name<=b.name?-1:1)});function loadFiles(startId){var id=startId;for(i=0;i<files.length;i++){var file=files[i];titleAlreadyAdded=!1;for(var j=0;j<movieFiles.length;j++){if(movieFiles[j].movie_filename==file.name){titleAlreadyAdded=!0;break}}
